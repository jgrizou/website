...
A full list of publication should be included with this curriculum vitæ, it can also be found on my website: [{{ "/publications/publications_pertype.pdf" | web_path }}]({{ "/publications/publications_pertype.pdf" | web_path }})
